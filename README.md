...
### Setup
You'll need an SD card normally readable by the Wii U. Simply copy the fw.img to the root of the SD, and your Linux kernel (see [linux-wiiu/linux-wiiu](https://gitlab.com/linux-wiiu/linux-wiiu)'s README for compiling) to the root of the SD, named `ppc-kernel.elf`. This will change soon, so don't get too comfy.
